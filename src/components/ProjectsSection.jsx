  ...
  return (
    <section id="projects" className="py-24 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div 
          className="relative w-100 h-100 mx-auto"
        ...
        >
          ...
          <div 
            ...
            style={{
              ...
              transform: `rotateY(${currentIndex * -90}deg) ${isHovering ? 'rotateX(-5deg) scale(1.05)' : 'rotateX(0deg) scale(1)'}`
            }}
          >
            {projectsData.map((project, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`h-full relative transition- duration-700 ${
                    isActive 
